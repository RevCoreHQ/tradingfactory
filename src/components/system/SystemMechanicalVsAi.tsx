    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-4 items-start">
        ...
        >
          ...
          <div className="space-y-2 text-xs text-muted-foreground leading-relaxed">
            <p>
              ...
              fire independently based on indicator values. Zero machine learning, zero black box.
            </p>
            <p>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-sm font-semibold text-foreground">Where Language Models Step In</h4>
          </div>
          <div className="space-y-3 text-xs text-muted-foreground leading-relaxed">
            <p>
              Language models are used in <strong className="text-foreground">6 places</strong>, all after the mechanical engine
      ...
      <div className="glass-card rounded-xl px-5 py-3 text-center">
        <p className="text-[13px] font-semibold text-muted-foreground">
          Language models do <strong className="text-foreground">not</strong> generate trade ideas. They <strong className="text-foreground">explain</strong> them.
        </p>
      </div>
    </div>
  );
