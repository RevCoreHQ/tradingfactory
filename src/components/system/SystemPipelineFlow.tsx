  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <PipelineStageCard number={3} title="Multi-Dimensional Regime Engine" subtitle="ATR percentile × BB width × EMA slope × ADX → volatility/structure/phase" icon={<Activity className="h-3.5 w-3.5" />} badge="mechanical" accentColor="green" defaultExpanded>
          <p>
        ...
        <PipelineStageCard number={4} title="Market Structure Analysis" subtitle="HH/HL/LH/LL swing classification + BOS/CHoCH detection" icon={<TrendingUp className="h-3.5 w-3.5" />} badge="mechanical" accentColor="green" defaultExpanded>
          <p>
        ...
        <PipelineStageCard number={5} title="Trading Style Selection" subtitle="Full regime + session score → intraday vs swing" icon={<Clock className="h-3.5 w-3.5" />} badge="mechanical" accentColor="amber" defaultExpanded>
          <p>
        ...
        <PipelineStageCard number={10} title="Hard Filters" subtitle="Quality gates that reject weak setups" icon={<ShieldAlert className="h-3.5 w-3.5" />} badge="filter" accentColor="red" defaultExpanded>
        ...
        <PipelineStageCard number={13} title="Portfolio Risk Gate" subtitle="Currency exposure caps, correlation blocking, drawdown throttle" icon={<ShieldCheck className="h-3.5 w-3.5" />} badge="filter" accentColor="red" defaultExpanded>
          <p>
        ...
        <PipelineStageCard number={15} title="Expectancy-Based Learning" subtitle="R-multiple tracking, time decay, Kelly sizing — outcomes improve future scoring" icon={<RefreshCw className="h-3.5 w-3.5" />} badge="mechanical" accentColor="green" defaultExpanded>
          <p>
